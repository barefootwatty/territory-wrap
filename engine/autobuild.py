...
- WATTY'S PREFERENCES: For Fly Fishing, strongly prefer SALTWATER species and barramundi over trout/freshwater; saltwater fly-tying video recommendations are welcome — when a story IS a video, include its URL and set "link_label" (e.g. "Watch the fly-tying tutorial"). Anything to do with Papua New Guinea (PNG) is always welcome — his lodges Bensbach and Lake Murray, PNG black bass and barramundi, the Sepik, and notable PNG good news — usually file PNG items under "International & Destinations".
